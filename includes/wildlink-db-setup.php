...
function wildlink_create_tables() {
    ...
    if ($wpdb->get_var("SHOW TABLES LIKE '$species_table'") != $species_table) {
        ...
        $initial_species = [
            ...
            ['common_name' => 'Moose', 'scientific_name' => 'Alces alces', 'description' => 'The moose, also known as elk in Europe, is the largest extant species in the deer family. They are primarily found in boreal and mixed deciduous forests.', 'image' => plugins_url('images/moose2.png', __FILE__)]
        ];
